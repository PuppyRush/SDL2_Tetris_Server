...
class MapSubject
        : public Subject<_Observer, std::unordered_map<typename _Observer::unique_type, std::shared_ptr<_Observer>>>
{
public:

    using _Base = Subject<_Observer, std::unordered_map<t_unique, std::shared_ptr<_Observer>>>;
